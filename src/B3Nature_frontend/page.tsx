					...
					<div className="grid md:grid-cols-2 gap-8">
						<Card className="bg-card-gradient border-primary/20">
							<CardContent className="p-6">
								...
								<p className="text-gray-300">
									B3Nature is an innovative project that aims to harmonize
									technology with nature, creating sustainable solutions for a
									better future. Our approach combines cutting-edge technology
						...
						<Card className="bg-card-gradient border-primary/20">
							<CardContent className="p-6">
								...
								<p className="text-gray-300">
									We're dedicated to developing eco-friendly technologies that
									promote sustainability while advancing technological
									capabilities. Join us in our mission to create a more
					...
					<Card className="bg-card-gradient border-primary/20 max-w-3xl mx-auto">
						<CardContent className="p-6">
							...
							<p className="text-gray-300 mb-4">
								Explore our open-source codebase and contribute to the
								development of B3Nature. We welcome collaborators who share our
				...
				<div className="container mx-auto px-4">
					...
					<div className="max-w-3xl mx-auto text-center">
						<p className="text-xl text-gray-300 mb-8">
							Help us bring B3Nature to life! We're seeking sponsors who believe
							in our vision of harmonizing technology with nature. Your support
							will accelerate the development of sustainable solutions for a
							better tomorrow.
						</p>
						<Card className="bg-card-gradient border-primary/20">
							<CardContent className="p-6">
								...
								<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
									...
									<Link
										href="https://www.linkedin.com/company/b3Pay/"
										target="_blank"
										className="flex items-center justify-center gap-2 p-3 rounded-lg bg-primary/10 hover:bg-primary/20 transition-colors"
									>
