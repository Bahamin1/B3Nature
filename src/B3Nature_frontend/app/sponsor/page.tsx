						...
						<Card className="bg-card-gradient border-primary/20">
							<CardContent className="p-6">
								...
								<p className="text-black-300 mb-6">
									By sponsoring B3Nature, you're investing in a sustainable
									future where technology and nature coexist harmoniously. Your
									support will help accelerate the development of innovative
								...
								<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
									...
									>
										...
										<div>
											...
											<p className="text-sm text-black-300">B3Pay</p>
										</div>
									</Link>
									<Link
									...
									>
										...
										<div>
											...
											<p className="text-sm text-black-300">B3Pay Company</p>
										</div>
									</Link>
