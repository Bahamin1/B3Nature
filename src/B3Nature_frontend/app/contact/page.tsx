...
export default function ContactPage() {
	...
	async function handleSubmit(formData: FormData) {
		if (isPending) return; // جلوگیری از ارسال‌های مکرر

		setIsPending(true); // غیرفعال کردن دکمه هنگام ارسال
		try {
			...
			setIsPending(false); // فعال کردن دوباره دکمه بعد از دریافت پاسخ
		}
	}
