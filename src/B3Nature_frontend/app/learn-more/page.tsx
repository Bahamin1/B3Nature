						...
						<Card className="bg-card-gradient border-primary/20">
							<CardContent className="p-6">
								...
								<p className="text-black-300 mb-6">
									B3Nature is an innovative initiative that aims to create
									sustainable solutions by harmonizing technology with nature.
									Our project focuses on developing eco-friendly technologies
									that promote environmental consciousness while advancing
					...
					<div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
						<Card className="bg-card-gradient border-primary/20">
							<CardContent className="p-6">
								...
								<ul className="text-black-300 space-y-2">
				...
				<div className="container mx-auto px-4">
					...
					<div className="max-w-3xl mx-auto text-center">
						<p className="text-xl text-black-300 mb-8">
							...
							technologically advanced future. There are many ways to contribute
							to the B3Nature project.
						</p>
