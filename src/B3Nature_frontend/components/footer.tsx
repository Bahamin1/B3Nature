        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/learn-more" className="text-gray-400 hover:text-primary">
                  Learn More
                </Link>
              </li>
              <li>
                <Link href="/sponsor" className="text-gray-400 hover:text-primary">
                  Sponsor
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <Link href="mailto:Bahamindehpour@gmail.com" className="text-gray-400 hover:text-primary">
                <Mail className="h-6 w-6" />
              </Link>
              <Link href="https://github.com/Bahamin1" target="_blank" className="text-gray-400 hover:text-primary">
